...
public class TrainingResultData
{
    ...
    public class RomMeasurement
    {
        ...
        //   감점은 이쪽만 본다.
        // ── 멈춤 진단 (2026-09-09 신설) ────────────────────────────
        // ★위 계수기가 <b>전부 0인데도</b> 측정이 안 되는 경우를 가르려고 만들었다.
        //   09-09 기기 테스트에서 신전이 64도에 10초 넘게 얼어붙었는데, 버린 프레임 0 ·
        //   손 유실 0.0초라 CSV만 보고 "손 문제가 아니다"라고 <b>반대로</b> 읽었다.
        //   릴리스는 로그가 잘리고 화면 진단도 꺼져 있어 이 파일이 유일한 통로다.
        public float staleSeconds;      // 각이 얼어붙어 있던 시간(초)
